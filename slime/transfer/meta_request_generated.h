...
struct RemoteMetaRequest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  uint32_t rkey() const {
    return GetField<uint32_t>(VT_RKEY, 0);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_RKEY, 4) &&
           VerifyOffset(verifier, VT_REMOTE_ADDRS) &&
           verifier.VerifyVector(remote_addrs()) &&
...
struct RemoteMetaRequestBuilder {
  ...
  void add_rkey(uint32_t rkey) {
    fbb_.AddElement<uint32_t>(RemoteMetaRequest::VT_RKEY, rkey, 0);
  }
  ...
  void add_op(int8_t op) {
    fbb_.AddElement<int8_t>(RemoteMetaRequest::VT_OP, op, 0);
  }
  explicit RemoteMetaRequestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline ::flatbuffers::Offset<RemoteMetaRequest> CreateRemoteMetaRequest(
    ...
    uint32_t rkey = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint64_t>> remote_addrs = 0,
    int8_t op = 0) {
...
inline ::flatbuffers::Offset<RemoteMetaRequest> CreateRemoteMetaRequestDirect(
    ...
    int32_t block_size = 0,
    uint32_t rkey = 0,
    const std::vector<uint64_t> *remote_addrs = nullptr,
    int8_t op = 0) {
  ...
  return CreateRemoteMetaRequest(
      _fbb,
      keys__,
      block_size,
      rkey,
...
inline bool VerifyRemoteMetaRequestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RemoteMetaRequest>(nullptr);
}

inline bool VerifySizePrefixedRemoteMetaRequestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RemoteMetaRequest>(nullptr);
}

inline void FinishRemoteMetaRequestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RemoteMetaRequest> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedRemoteMetaRequestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RemoteMetaRequest> root) {
