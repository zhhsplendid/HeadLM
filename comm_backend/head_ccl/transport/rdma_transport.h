...
public:
    ...
    */
    ...
    int64_t register_remote_memory_region(std::string mr_key, json json_mr_info)
    {
    ...
    json local_info()
    {
        return json{{"rdma_info", local_rdma_info_.to_json()}, {"mr_info", memory_pool_.local_mr_info_to_json()}};
    }
