...
{
    std::string lvl = get_env_variable("HEADLM_LOG_LEVEL");
...
#define HEADLM_LOG_LEVEL(MsgType, Level, ...)                                                                           \
    {                                                                                                                  \
...
// Error and Warn
#define HEADLM_LOG_ERROR(...) HEADLM_LOG_LEVEL("Error", 0, __VA_ARGS__)
#define HEADLM_LOG_WARN(...) HEADLM_LOG_LEVEL("Warn", 0, __VA_ARGS__)

// Info
#define HEADLM_LOG_INFO(...) HEADLM_LOG_LEVEL("Info", 1, __VA_ARGS__)

// Debug
#define HEADLM_LOG_DEBUG(...) HEADLM_LOG_LEVEL("Debug", 2, __VA_ARGS__)