...
def is_backend_supported(backend_name: str) -> bool:
    supported = False
    old_master_addr = os.environ['MASTER_ADDR'] if 'MASTER_ADDR' in os.environ else None
    old_master_port = os.environ['MASTER_PORT'] if 'MASTER_PORT' in os.environ else None
